...
<div class="bg-[#00000090] w-full z-30 absolute flex justify-center items-center min-h-screen px-2">
    <div class="bg-white shadow-md rounded-md p-4 max-w-xl w-full">
        <h1 class="text-xl font-bold ">Change email:</h1>
        <hr class="my-2">
        <form action="/email-changed" method="POST" class="flex flex-col gap-4 my-4">
            <div class="">
                <label for="email">New email:</label>
                <input type="email" name="email" id="email" class="border bg-body border-outline p-1 px-2 rounded-md w-full outline-none" placeholder="example@example.com" required>
