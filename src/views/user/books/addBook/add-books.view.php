    ...
    <div class="bg-white shadow-md rounded-md p-4 max-w-xl w-full">
        ...
        <form action="/added-book" method="POST" class="flex flex-col gap-4 my-4">
            <div class="">
                ...
                <input type="text" name="bookName" id="bookName" class="border bg-body border-outline p-1 px-2 rounded-md w-full outline-none" placeholder="Example: The Book">
            ...
            <div>
                ...
                <input type="text" name="authorName" id="authorName" class="border bg-body border-outline p-1 px-2 rounded-md w-full outline-none" placeholder="Example: Juan Dela Cruz">
            ...
            <div class="flex justify-between w-full gap-2">
                ...
                <a href="/myBooks" class="flex justify-center w-full"><button type="submit" class="text-white bg-[#28A745] py-1 font-bold rounded-md shadow-md tracking-widest w-full hover:brightness-110 duration-300">DONE</button></a>
            </div>
        </form>
