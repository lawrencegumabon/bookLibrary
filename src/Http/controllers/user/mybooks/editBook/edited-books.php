...
$book = $db->query('SELECT * FROM books WHERE title = :title AND author = :author AND category = :category AND user_id = :user_id', [
    'title' => $bookName,
    'author' => $authorName,
    'category' => $category,
    'user_id' => $userID
...
if ($book) {
    ...
    return require 'src\views\user\books\editBook\edit-books.view.php';
}
